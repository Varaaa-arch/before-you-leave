...
const MEMORIES: Memory[] = [
  {
    id: 1,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/1.jpg",
    caption: "Foto Bareng Pertama kita yaaa ini di sekolah hihi",
    rotate: -2.5,
  },
  {
    id: 2,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/2.webp",
    caption: "Lucu bangettttt",
    rotate: 1.2,
  },
  {
    id: 3,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/3.webp",
    caption: "Hihi gemes banget ya kitaa :P",
    rotate: -1.8,
  },
  {
    id: 4,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/4.webp",
    caption: "Ini pas kita mau nonton apaa yaaaaa, lucu banget",
    rotate: 2.1,
  },
  {
    id: 5,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/5.webp",
    caption: "Lucu banget ya kamu..",
    rotate: -0.8,
  },
  {
    id: 6,
  ...
  {
    id: 7,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/7.jpg",
    caption: "LUCUUU BANGETT, Pas kita jajan bingxuee",
    rotate: -2.2,
  },
  {
    id: 8,
    imageUrl: "https://qzjxfmdilqdybxkhhpdk.supabase.co/storage/v1/object/public/PhotoCard/8.jpg",
    caption: "Seperti BEGALLLL hihi",
    rotate: 2.8,
  },
]
